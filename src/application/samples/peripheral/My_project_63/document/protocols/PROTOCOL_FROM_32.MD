...
{
  "cmd": "mqtt_connect",
  "host": "mqtt://thingskit.aiotcomm.com.cn",
  "port": 11883,
  "clean_session": 1,
  "keepalive": 60
}
...
```
{
  ...
  "current_host": "mqtt://thingskit.aiotcomm.com.cn",
  "current_port": 11883
}
```
...
// MQTT配置
#define L610_MQTT_USERNAME   "aiotcomm"
#define L610_MQTT_PASSWORD   "aiotcomm"
...
**最后更新**: 2026-05-19  
**维护者**: TcXc  
**反馈邮箱**: 202500201013@stumail.sztu.edu.cn
