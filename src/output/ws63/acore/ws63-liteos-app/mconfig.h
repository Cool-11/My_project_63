...
#define CONFIG_SAMPLE_SUPPORT_MY_PROJECT_63 1
#define CONFIG_MY_PROJECT_63_ENABLE_STARTUP_LOG 1
...
#define CONFIG_PWM_GROUP_NUM 4
#define CONFIG_PWM_CHANNEL_NUM 8
...
#define CONFIG_AT_PRINT_BUFFER_SIZE 384
